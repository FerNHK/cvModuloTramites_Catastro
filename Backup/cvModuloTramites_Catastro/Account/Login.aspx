                ...
                <h1 class="head_principal"><strong>Modulo de Tramites de Catastro</strong> </h1>   
                     <hr class="featurette-divider">
                        <div class="col-lg-10 col-lg-offset-1  col-xs-12 col-xs-offset-0
                                ...
                                clave catastral para iniciar su session y acceda a su informacion personal. </p>
                            ...
                            <div class="panel-heading">
                             ...
                             <asp:ScriptManager ID="ScriptManager1" runat="server">
                               ...
                               <div class="form-group ">
                                 ...
                                 <div class="form-group  ">
                                      <asp:Button ID="Button1" class="button_sub btn btn-info " runat="server"  Text="Inicio" 
