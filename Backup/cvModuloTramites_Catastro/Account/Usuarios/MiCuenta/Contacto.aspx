  ...
  <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="Principal.aspx">Modulo de Tramites</a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            
             
            <ul class="nav navbar-nav navbar-right">
              <li class="active"><a id="A1" runat="server" href="Contacto.aspx">Contacto <span class="sr-only">(current)</span></a></li>
                     ...
                     <asp:LoginView ID="LoginView1" runat="server" EnableViewState="false">
                        <LoggedInTemplate>
                            <a href="#" 
                               ...
                               role="button" 
                               aria-haspopup="true" 
                               aria-expanded="false"><asp:LoginName ID="HeadLoginName" runat="server" /> <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              
                              <li><asp:LoginStatus ID="HeadLoginStatus" runat="server" LogoutAction="Redirect" onloggedout="afterOut" 
                                    onloggingout="previewOut" LogoutText="Salir" LogoutPageUrl="~/Account/Login.aspx"/> </li>
           ...
           <div class="row featurette">
             ...
             <div class="row featurette">
              ...
              <div class="col-lg-6 col-md-5 col-sm-5 ">
                     ...
                     <div class="form-group">
                          <label for="exampleInputFile">Proporcione su archivo de pago. De preferencia PDF</label>
