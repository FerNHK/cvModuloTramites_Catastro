       ...
       public static string editNombre = "";
        ...
        protected void btnActualizarArchivo_Click(object sender, EventArgs e)
        {
            ...
            if (UpFile.PostedFile==null || UpFile.PostedFile.ContentLength == 0)
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          $('#MainContent_tipeError').addClass('modal-header-warning'); 
                                                          $('#MainContent_mensajeTitulo').text('Advertencia');$('#MainContent_mensajeCuerpo').text('No existe un archivo para ser alamcenado');});", true);
            ...
            else
            {
                ...
                if (consultaClave.cActualizacionArchivo() == true)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          $('#MainContent_tipeError').addClass('modal-header-success'); 
                                                          $('#MainContent_mensajeTitulo').text('Exito'); $('#MainContent_mensajeUsuario').addClass('textalerta'); " + "$('#MainContent_mensajeCuerpo').text('Exito  al actualizar su archivo de pago');});", true);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          $('#MainContent_tipeError').addClass('modal-header-danger'); 
                                                          $('#MainContent_mensajeTitulo').text('Error');$('#MainContent_mensajeCuerpo').text('A causa de un erro su archivo no pudo ser enviado satisfactoriamente. Intentelo mas tarde.');});", true);
        ...
        protected void btnCancelar_clicklistener(object sender, EventArgs e)
        {
            ...
            if (consultaClave.getFolio().Equals(""))
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          ...
                                                          $('#MainContent_mensajeTitulo').text('Informativo');$('#MainContent_mensajeCuerpo').text('Usted no ha elegido un tramite de la tabla para poder cancelarlo. Seleccione uno y pruebe volver a intentarlo.');});", true);
            ...
            else
            {
                if (consultaClave.cCancelacionTramite() == true)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          $('#MainContent_tipeError').addClass('modal-header-success'); 
                                                          $('#MainContent_mensajeTitulo').text('Exito');$('#MainContent_mensajeCuerpo').text('Usted ha cancelado su tramite');});", true);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          $('#MainContent_tipeError').addClass('modal-header-danger'); 
                                                          $('#MainContent_mensajeTitulo').text('Exito');$('#MainContent_mensajeCuerpo').text('A causa de un error no se ha podido cancelar su tramite. Intentelo mas tarde.');});", true);
           ...
           // setCambio();
                ...
                editTelefono != null && editTelefono != "")
            {
                ...
                if (consultaClave.editUsuario() == true)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          $('#MainContent_tipeError').addClass('modal-header-success'); 
                                                          $('#MainContent_mensajeTitulo').text('Exito'); $('#MainContent_mensajeUsuario').addClass('textalerta'); " + name + "$('#MainContent_mensajeCuerpo').text('Exito al camabiar su usuario');});", true);   
