      ...
      <nav class="navbar navbar-inverse">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Principal.aspx">Modulo de Tramites
                  </a>
              &nbsp;</div>
              <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                  <li><a id="A1" runat="server" href="Contacto.aspx">Contacto <span class="sr-only">(current)</span></a></li>
                     ...
                     <asp:LoginView ID="LoginView1" runat="server" EnableViewState="false">
                        <LoggedInTemplate>
                            ...
                            <ul class="dropdown-menu">
                              <li><a data-toggle="modal" href="#ActualizarUsuario">Editar Usuario</a></li>
                              <li><asp:LoginStatus ID="HeadLoginStatus" runat="server" LogoutAction="Redirect" onloggedout="afterOut" 
                                    onloggingout="previewOut" LogoutText="Salir" LogoutPageUrl="~/Account/Login.aspx"/> 
                              </li>
                            </ul>
                            </LoggedInTemplate>
                     </asp:LoginView>
            ...
            <div class="panel-body">       	
               ...
               <div class="row centrado">
                ...
                <asp:UpdatePanel ID="genAcuse" runat="server">
                    <ContentTemplate>
                     <asp:Button ID="btnGenerarAcuse" class="btn btn-lg btn-danger" 
                                runat="server"  Text="Imprimir" OnClick="btnGenerarAcuse_clicklistener"/>
                     </ContentTemplate>
                     <Triggers>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
                 ...
                 <asp:Button ID="btnCancelar" class="btn btn-lg btn-danger" 
                            runat="server"  Text="Cancelar" OnClick="btnCancelar_clicklistener" />
                              </ContentTemplate>
                     <Triggers>
		   ...
		   <div class="form-group">
            ...
            <label class="Centrado" style=" text-align: center;">Proporcione su archivo de pago. De preferencia PDF</label> 
                 ...
                 <asp:UpdatePanel ID="actFile" runat="server">
                                    <ContentTemplate> 
                                     <asp:FileUpload ID="UpFile"  runat="server" Enabled="false" />	<br />
                                         <asp:RegularExpressionValidator
                                        id="RegularExpressionValidator1" runat="server"
                                        ErrorMessage="Only PDF files are allowed!"
                                        ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"
                                        ControlToValidate="UpFile" CssClass="alert alert-warning"></asp:RegularExpressionValidator>
                                    </ContentTemplate>
                                  </asp:UpdatePanel>
                                  	<br />

                                      <asp:Button ID="btnActualizarArchivo" class="button_sub  btn btn-info " 
                            runat="server"  Text="Actualizar Archivo" OnClick="btnActualizarArchivo_Click" />
                            <br /><br />
      ...
      <div class="modal-footer">
       ...
       <ContentTemplate>
                      <asp:Button ID="btnEditarContacto" class="button_sub  btn btn-info " 
                            runat="server"  Text="Editar Perfil" OnClick="btnEditarContacto_clicklistener" />
         </ContentTemplate>
         <Triggers>
