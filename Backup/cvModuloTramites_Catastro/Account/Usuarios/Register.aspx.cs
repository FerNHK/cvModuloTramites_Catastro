...
namespace cvModuloTramites_Catastro.Account
{
    ...
    {
        #region Variables_
        private static String session_ = "", contacto="", email="", tel="" ;
               ...
               || tel != "" || tel != null)
            {
                ...
                if (consultaClave.RegistroUsuarioNuevo() == true)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "CumstomText", @"$(function(){
                                                          ...
                                                          $('#MainContent_mensajeTitulo').text('Exito'); $('#MainContent_mensajeUsuario').addClass('textalerta'); " + "$('#MainContent_mensajeCuerpo').text('Exito  al almacenar su archivo de pago');});", true);
